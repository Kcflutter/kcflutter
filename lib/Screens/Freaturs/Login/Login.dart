...
import 'package:krishnacomingflutter/Screens/Freaturs/ForgetPassword/ForgetPassword.dart';
                                    ...
                                    child: Container(
                                      ...
                                      child: Align(
                                        alignment: Alignment.centerRight,
                                          child: Text("Forget Password",style: TextStyle(fontSize: 13, fontFamily: "Trebuchet", color: Colors.green),)),
                                    ),
                                  ),
                                  SizedBox(height: 22,),
                                  Row(
